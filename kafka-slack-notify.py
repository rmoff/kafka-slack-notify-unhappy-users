...
bootstrapServers = os.environ.get('BOOTSTRAP_SERVERS')
if bootstrapServers is None:
    bootstrapServers = 'localhost:9092'
    print('\n\nNOTE: Defaulting to localhost:9092. If you want to use a different broker then provide environment variable BOOTSTRAP_SERVERS *******\n')

kafkaTopic = os.environ.get('KAFKA_TOPIC')
if kafkaTopic is None:
    kafkaTopic = 'UNHAPPY_PLATINUM_CUSTOMERS'
    print('\n\nNOTE: Defaulting to topic UNHAPPY_PLATINUM_CUSTOMERS. If you want to use a different topic then provide environment variable KAFKA_TOPIC *******\n')
